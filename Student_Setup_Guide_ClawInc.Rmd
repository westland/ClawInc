...
## Fix the Configuration (Required — Schema Update)
...
- `YOUR_ANTHROPIC_API_KEY` → your `sk-ant-api03-...` key
- `YOUR_HENRY_BOT_TOKEN` → the token BotFather gave you for the Henry bot
- `YOUR_CODER_BOT_TOKEN` → the Coder bot token
- `YOUR_SCOUT_BOT_TOKEN` → the Scout bot token
- `YOUR_WRITER_BOT_TOKEN` → the Writer bot token
...
# Part 6: Access the Dashboard in a Browser
...
**Windows — PuTTY (GUI):**
1. Open PuTTY
2. Enter your IP in **Host Name**
3. Go to **Connection → SSH → Tunnels**
4. Source port: `18789`, Destination: `localhost:18789`, click **Add**
5. Click **Open** and log in
