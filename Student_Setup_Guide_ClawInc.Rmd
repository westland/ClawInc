...
You can speak your commands instead of typing them. Telegram transcribes the voice note automatically before passing it to the agent — no setup required, already working on your current deployment.

**Mobile (iPhone or Android):** Hold the **microphone icon** in the message bar, speak your command, release to send.

**Telegram Desktop (Windows/Mac):** Click the **microphone icon** in the message bar, speak, then click send.

**Best practice — use Henry for multi-agent voice commands:**

Henry is your Chief of Staff and can delegate to the whole team from a single voice message. For example:
...
> **Important:** Use **voice notes** (hold the mic button), not voice calls. Voice calls do not reach the agents — only voice notes do.
